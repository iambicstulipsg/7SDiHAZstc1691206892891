...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string APP_NAME = "Coloring";
        private static string COMPANY_NAME = "1691207094871852793148";
        private static string BUILD_VERSION_NAME = "1.0.0";
        private static string PACKAGENAME = "com.coloringcoloring.col";
        private static string PATH_KEYSTORE = "data.keystore";
        private static string KEYSTORE_PASS = "nineone";
        private static string KEY_ALIAS_NAME = "nineone";
        private static string KEY_ALIAS_PASS = "nineone";
